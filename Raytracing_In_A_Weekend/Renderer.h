...
private:
	...
	void render_row(Image& im_out, size_t row_idx, const Camera& cam, const HittableScene& scene);
	RGB_Pixel render_pixel(size_t x, size_t y, const Camera& cam, const HittableScene& scene);
